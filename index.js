...
═══════════════════════════════════════
📚 أمثلة حقيقية على هوكات ناجحة (تعلم منها الأسلوب - لا تنسخها):
═══════════════════════════════════════

**فئة: رقم صادم**
• "المصريين صرفوا 70 مليار جنيه على السجاير في سنة واحدة بس."
• "شقة في الشيخ زايد بـ 40 مليون جنيه واتباعت في يومين."
• "أنت بتضيع 45 يوم كل سنة وأنت بتعمل سكرول على تيك توك."

**فئة: سؤال محير**
• "ليه أبل بتبيع الموبايل بـ 60 ألف جنيه والناس بتقف طوابير؟"
• "إزاي كريم بيوصلك بـ 20 جنيه وبيدفع للسواق 30 جنيه وبيكسب؟"
• "ليه الفقير بيشتري أيفون قسط والغني بيشتري دهب وأسهم؟"

**فئة: تحدي المعتقدات**
• "الشهادة الجامعية مبقتش تضمن وظيفة، والشركات الكبيرة بطلت تطلبها."
• "تحويش الفلوس في البنك هو أسرع طريقة عشان تخسر قيمتها."
• "الصحيان الساعة 5 الفجر مش هو سر نجاح المليارديرات."

**فئة: قصة شخصية**
• "صاحبي سدد ديون بـ 100 ألف جنيه في سنة لما بطل منظرة."
• "اترفضت في 20 انترفيو، والنهاردة أنا اللي بعين الموظفين دول."

**فئة: مقارنة صادمة**
• "تيشيرت زارا بـ 2000 جنيه، وتكلفته في المصنع 150 جنيه بس."
• "سعر تويوتا كورولا في مصر يجيبلك بورش مستعملة في دبي."
═══════════════════════════════════════
...
- **رقم محدد:** بدل "آلاف" قول "3,500" - الأرقام المحددة تصدم أكتر.

🎣 المطلوب: 3 هوكات مختلفة تماماً:

**Hook A - صادم (Shock):** رقم أو حقيقة تكسر المنطق (زي الأمثلة فوق).
**Hook B - سؤال (Question):** سؤال يفتح فضول لا يمكن تجاهله.
**Hook C - فائدة (Benefit):** فائدة مباشرة للمشاهد.

⚠️ ممنوع تماماً: "تخيل معايا"، "بص كده"، "خبر عاجل"، "لو قلتلك"، "هتتصدم"
...
`) : '';
  ...
  const prompt = isAr ? 
`أنت "حكواتي سينمائي" عبقري، مش مجرد كاتب محتوى.

═══════════════════════════════════════
📚 مثال على سكربت احترافي (تعلم منه الأسلوب):
═══════════════════════════════════════
**الهوك:** "مصر بتبني مدينة بحجم دولة سنغافورة كلها، والناس لسه فاكراها مجرد عمارات جديدة!"

**الجسم:** أنت متخيل إن "النهر الأخضر" اللي بيتزرع هناك ده، مساحته 3 أضعاف "السنترال بارك" بتاعة نيويورك؟.. إحنا بنتكلم عن مدينة ذكية بالكامل، يعني إشارات المرور، الكاميرات، وحتى أعمدة النور مربوطة بشبكة واحدة. عندك البرج الأيقوني، أطول برج في أفريقيا بارتفاع 385 متر، يعني أعلى من برج إيفل بـ 85 متر كاملين. المدينة دي معمولة عشان تستوعب 6.5 مليون بني آدم، وتخف الضغط عن القاهرة اللي بتنفجر.. دي مش مجرد نقلة، دي خريطة جديدة للبلد بتترسم قدام عنينا.

**الـ CTA:** تفتكر هتقدر تشتري شقة هناك، ولا الأسعار هتبقى للخلايجة والأجانب بس؟

═══════════════════════════════════════
📚 مثال تاني (موضوع مختلف):
═══════════════════════════════════════
**الهوك:** "الروبوت مش هياخد مكانك في الشغل.. اللي هياخد مكانك هو واحد بيعرف يستخدم الـ AI أحسن منك!"

**الجسم:** دلوقتي بضغطة زرار على ChatGPT أو Midjourney، شغلانة كانت بتاخد 5 ساعات بقت تخلص في 5 دقايق. المحاسب، الكاتب، المبرمج.. مفيش حد في أمان بنسبة 100%.. بس الخطر الحقيقي مش في التكنولوجيا، الخطر في إنك تفضل شغال بالطريقة القديمة. الشركات مش هتمشي الموظفين عشان توفر، هتمشي الموظف "البطيء" وتخلي الموظف "الذكي" اللي بيعمل شغل 3 بني آدمين باستخدام الأدوات دي. أنت دلوقتي قدام خيارين: يا تتعلم الأدوات دي وتبقى سوبر مان، يا تنقرض زي الديناصورات.

**الـ CTA:** بدأت تستخدم الذكاء الاصطناعي في شغلك ولا لسه خايف منه؟

═══════════════════════════════════════
🎯 لاحظ في الأمثلة دي:
═══════════════════════════════════════
✅ المقارنات البشرية: "3 أضعاف السنترال بارك"، "أعلى من برج إيفل بـ 85 متر"
✅ الأرقام المحددة: "385 متر"، "6.5 مليون"، "5 ساعات بقت 5 دقايق"
✅ اللغة البسيطة: "بتنفجر"، "تنقرض زي الديناصورات"
✅ الـ So What: كل معلومة مربوطة بتأثير على المشاهد
✅ الـ CTA سؤال: يفتح نقاش ويطلب رأي
...
🚫 ممنوع نهائياً:
- "يُعد"، "حيث أن"، "علاوة على ذلك"، "مما يؤدي"
- "تخيل معايا"، "يا جماعة"، "بص كده"، "هل كنت تعلم"
- "في هذا الفيديو"، "دعونا نستكشف"، "ركز معايا"

الـ HOOK المختار (ابدأ به حرفياً): ${hook}
...
async function geminiPolish(script, datasheet, style, language) {
  ...
  const prompt = isAr ? `أنت "ناقد ومحرر محتوى بشري" قاسي جداً. وظيفتك هي مراجعة السكربت وتحويله من "كلام AI" إلى "كلام بشري حقيقي".

═══════════════════════════════════════
📝 السكربت المطلوب تحسينه (${inputWordCount} كلمة):
═══════════════════════════════════════
${script}

═══════════════════════════════════════
❌ مثال على كلام AI سيء (ممنوع):
═══════════════════════════════════════
"يُعد هذا المشروع من أهم المشاريع، حيث أنه يُشير إلى تطورات ملحوظة. علاوة على ذلك، تجدر الإشارة إلى أن هذا المجال يُعتبر واعداً. مما لا شك فيه أن التحديات موجودة، لكن بفضل الجهود المبذولة..."

═══════════════════════════════════════
✅ مثال على كلام بشري ممتاز (المطلوب):
═══════════════════════════════════════
"دلوقتي بضغطة زرار على ChatGPT، شغلانة كانت بتاخد 5 ساعات بقت تخلص في 5 دقايق. المحاسب، الكاتب، المبرمج.. مفيش حد في أمان بنسبة 100%.. بس الخطر الحقيقي مش في التكنولوجيا، الخطر في إنك تفضل شغال بالطريقة القديمة."
...
❌ "حيث أنه يُشير" → ✅ "يعني"
❌ "علاوة على ذلك" → ✅ "وكمان"
❌ "تجدر الإشارة" → ✅ (احذفها - حشو)
❌ "مما لا شك فيه" → ✅ (احذفها - حشو)
❌ "بفضل الجهود المبذولة" → ✅ "عشان الناس اشتغلت صح"
...
🚨 قواعد صارمة:
1. **الهوك ثابت:** الجملة الأولى ممنوع تتغير حرفياً!
2. **الطول مقدس:** السكربت لازم يكون ${minOutputWords}+ كلمة.
3. **شيل الفصحى:** أي "يُعد"، "حيث"، "علاوة"، "تجدر" → حولها لعامي.
4. **شيل الحشو:** أي كلمة مفيش منها فايدة → احذفها.
5. **ممنوع ميتا-تكست:** ممنوع "قمت بتحسين" أو "بصفتي" - رد بالسكربت مباشرة.
6. **ممنوع تعليمات مونتاج:** شيل أي [زووم] أو [B-roll].

المطلوب: السكربت النهائي فقط.` : 
