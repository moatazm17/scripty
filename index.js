...
const RULES = {
  general: [
    'اكتب بطريقة سلسة وطبيعية - زي ما بتتكلم مع صاحبك',
...
async function generateScript(topic, datasheet, hook, style, language, duration) {
  ...
  const prompt = `أنت كاتب سكربتات محترف لفيديوهات Short. اكتب سكربت (${duration} ثانية) عن "${topic}".
...
═══════════════════════════════════════
🎭 أسلوب الكتابة: ${styleTemplate.name}
═══════════════════════════════════════
${styleTemplate.tone}
...
📐 هيكل السكربت:
═══════════════════════════════════════
1. البداية (3 ثواني): جذب الانتباه فوراً
2. السياق (10 ثواني): اشرح الموضوع بسرعة
3. المحتوى (35 ثانية): قدم المعلومات المهمة بتسلسل منطقي
4. الختام (12 ثانية): اطلب التفاعل والاشتراك
...
المهم: اكتب السكربت بشكل سلس ومتدفق، كأنك بتحكي قصة لصاحبك. لا تستخدم انتقالات مفاجئة أو عبارات مصطنعة.
