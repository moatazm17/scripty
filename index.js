...
═══════════════════════════════════════
🎣 الـ HOOK (إلزامي - استخدمه بالحرف):
═══════════════════════════════════════
${hook}

⚠️ مهم جداً: السكربت لازم يبدأ بالـ HOOK ده بالظبط - حرف بحرف!
...
═══════════════════════════════════════
📐 هيكل السكربت (60 ثانية):
═══════════════════════════════════════
1. 🎣 HOOK (3s): 
   → ابدأ بالـ hook اللي فوق بالظبط (MANDATORY)
   
2. 📍 CONTEXT (12s): 
   → اشرح الموضوع والسياق - ليه مهم دلوقتي؟
   
3. 📚 DEEP DIVE (35s): 
   → ادخل في التفاصيل المهمة:
...
═══════════════════════════════════════
🎣 الـ HOOK الأصلي (لازم يكون موجود):
═══════════════════════════════════════
${originalHook}
...
7. **قوّي الـ Hook:**
   - لو الـ HOOK في البداية بس ضعيف أو ما فيهوش إثارة، قويه
   - خليه يجذب الانتباه ويثير الفضول
   - ما تغيرش معناه الأساسي، بس حسّن تأثيره
